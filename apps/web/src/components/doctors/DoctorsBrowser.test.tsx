...
const doctor = {
  ...
  slug: 'aram-grigoryan',
  specialty: { id: 's1', name: 'Cardiology', slug: 'cardiology' },
  centers: [{ id: 'c1', name: 'Heart Care', slug: 'heart-care', city: 'Yerevan' }],
  shortDescription: 'Experienced cardiologist.',
  biography: 'Bio',
  education: [],
  certifications: [],
  treatments: [],
...
beforeEach(() => {
  ...
  getSpecialtiesMock.mockResolvedValue([
    { id: 's1', name: 'Cardiology', slug: 'cardiology', shortDescription: '', description: '', treatments: [], isActive: true, displayOrder: 1, createdAt: '', updatedAt: '' },
  ]);
